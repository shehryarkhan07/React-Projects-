...
export default function Header() {
  ...
  return (
    ...
    <header className="shadow sticky z-50 top-0">
        ...
        <nav className="bg-white border-gray-200 px0 lg:px-6 py-2.5">
            ...
            <Link to="#" className="text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 lg:py-2.5 mr-2 focus:outline-none">
